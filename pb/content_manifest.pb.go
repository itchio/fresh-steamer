...
const file_content_manifest_proto_rawDesc = "" +
	...
	"\tsignature\x18\x01 \x01(\fR\tsignatureB\x05H\x01\x80\x01\x00"
...
var file_content_manifest_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_content_manifest_proto_goTypes = []any{
	...
	(*ContentManifestPayload_FileMapping)(nil),           // 3: ContentManifestPayload.FileMapping
	(*ContentManifestPayload_FileMapping_ChunkData)(nil), // 4: ContentManifestPayload.FileMapping.ChunkData
}
var file_content_manifest_proto_depIdxs = []int32{
	3, // 0: ContentManifestPayload.mappings:type_name -> ContentManifestPayload.FileMapping
	4, // 1: ContentManifestPayload.FileMapping.chunks:type_name -> ContentManifestPayload.FileMapping.ChunkData
