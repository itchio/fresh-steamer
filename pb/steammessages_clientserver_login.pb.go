...
const file_steammessages_clientserver_login_proto_rawDesc = "" +
	...
	"\x04hmac\x18\x05 \x01(\fR\x04hmac\"\xe4\x13\n" +
	...
	"\x0ffamily_group_id\x18\x1f \x01(\x04R\rfamilyGroupId\"2\n" +
	"\x13CMsgClientLoggedOff\x12\x1b\n" +
	"\aeresult\x18\x01 \x01(\x05:\x012R\aeresultB\x05H\x01\x80\x01\x00"
...
var file_steammessages_clientserver_login_proto_goTypes = []any{
	...
	(*CMsgClientLogon)(nil),         // 2: CMsgClientLogon
	(*CMsgClientLogonResponse)(nil), // 3: CMsgClientLogonResponse
	(*CMsgClientLoggedOff)(nil),     // 4: CMsgClientLoggedOff
